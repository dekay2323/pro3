...
** [ ] Show if data entered by User
** Able to attach vendors document

!! * RFQ List borken new roles

* [ ] Admin allowed to enter pricing (vendor leave off for now)
** [ ] Vendor acting
** [ ] User should be able to enter data for all vendors on the editable table view
