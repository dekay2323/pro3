...
<fieldset class="form">
    ...
    <div class="fieldcontain"><label>Description</label>${materialRequest?.name}</div>
    ...
    <div class="fieldcontain"><label>Closing Date</label>${materialRequest?.closingDate}</div>
