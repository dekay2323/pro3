...
<fieldset class="form">
    <f:with bean="materialRequest">
        ...
        <div class="fieldcontain"><label>ReqNumber</label>${materialRequest?.reqNumber}</div>
        ...
        <div class="fieldcontain"><label>Closing Date</label>${materialRequest?.closingDate} (${materialRequest?.daysLeftTillClose()} days left)</div>
    </f:with>
</fieldset>
